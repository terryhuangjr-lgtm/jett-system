#!/usr/bin/env node
/**
 * Allen Iverson Refractors 1996-2008 Search
 */
...
async function searchAIRefractors() {
  ...
  try {
    const search = {
      name: 'Allen Iverson Refractors 1996-2008',
    ...
    const filtered = items.filter(item => {
      ...
      const yearMatch = title.match(/199[6-9]|200[0-8]|1996|1997|1998|1999|2000|2001|2002|2003|2004|2005|2006|2007|2008/);
    ...
    const reportFile = path.join(__dirname, 'results', `ai-refractors-${new Date().toISOString().split('T')[0]}.json`);
...
function printResults(top10, duration, reportFile, summary) {
  console.log('═══════════════════════════════════════════════════');
  console.log('🏀 TOP 10 ALLEN IVERSON REFRACTORS (1996-2008)');
  console.log('═══════════════════════════════════════════════════\n');
