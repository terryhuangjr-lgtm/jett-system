...
class TitleAnalyzer {
  constructor() {
    ...
    this.redFlags = {
      ...
      // Negotiable pricing (minor flag - not necessarily bad)
      negotiable: ['obo', 'or best offer', 'make offer', 'open to offers'],
    ...
    this.weights = {
      asIs: -2,
      noReturns: -2,
      negotiable: -0.5,        // REFINED: Lowered from -1.5 (negotiable != bad)
      conditionIssues: -1,
      vague: -1,
      damage: -3,
