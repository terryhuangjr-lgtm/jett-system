...
All AI agents (MiniMax, Claude Code, Jett, etc.) must follow these rules.
...
4. **Update docs** - If you change functionality, update README
...
### For MiniMax
You're typically used for building new features. Always:
1. Read the full repo context first
2. Ask which model to use (Haiku vs Sonnet)
3. Test thoroughly before committing
4. Document what you built in CHANGELOG

### For Claude Code
You're typically used for debugging complex issues. Always:
1. Check git history to see what changed recently
2. Look for related commits that might have caused issues
3. Test fixes locally before committing
4. Consider if this is a Haiku vs Sonnet model issue

### For Jett (Self-Modification)
When you modify your own code:
1. Be extra careful - you're changing yourself
2. Always keep a working backup
3. Test changes thoroughly
4. Document everything clearly
5. If unsure, ask Terry first
